...
I want to develop a full-stack application using a [MERN](https://www.geeksforgeeks.org/mern/understand-mern-stack/)-like stack. However, the main requirements for me are to use the [Express.js](https://expressjs.com/) and [React.js](https://react.dev/) frameworks. My app idea is 'Workout Pro', which boils down to a personalized daily fitness journal.
